...
ggplot(successful_read_latency_data, aes(x = timestamp_sec, y = metric_value, color = test_id)) +
    ...
    labs(x = "Time (HH:MM:SS)", y = "Read Latency (ms)", title = "Read Latency per Second") +
...
ggplot(successful_update_latency_data, aes(x = timestamp_sec, y = metric_value, color = test_id)) +
    ...
    labs(x = "Time (HH:MM:SS)", y = "Update Latency (ms)", title = "Update Latency per Second") +
    scale_x_time(labels = scales::time_format("%H:%M:%S")) +
    theme_minimal() +
    theme(legend.position = "bottom")
...
ggplot(successful_latency_data, aes(x = timestamp_sec, y = metric_value, color = test_id)) +
    ...
    labs(x = "Time (HH:MM:SS)", y = "Operation Latency (ms)", title = "Operation Latency per Second") +
    scale_x_time(labels = scales::time_format("%H:%M:%S")) +
    theme_minimal() +
    theme(legend.position = "bottom")
