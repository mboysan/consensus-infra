...
plot_read_latency <- read.csv(paste(input_folder, "plot_read_latency.dat", sep="/"), header = TRUE)
...
plot_update_latency <- read.csv(paste(input_folder, "plot_update_latency.dat", sep="/"), header = TRUE)
...
plot_operation_latency <- read.csv(paste(input_folder, "plot_operation_latency.dat", sep="/"), header = TRUE)
